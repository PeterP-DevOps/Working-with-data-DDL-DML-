# Домашнее задание к занятию «Работа с данными (DDL/DML)» - Петр Петров
### Задание 1.
...
### Решение 1.
Создаём новую учётную запись пользователя MySQL с именем sys_temp:  
...
### Решение 2.
Таблица, в которой первом столбце названия таблиц восстановленной базы, во втором названия первичных ключей этих таблиц:  
![скриншот](pic/7.png)  
